// Script that will be injected and will execute on
...
/// The element we will do everything from
...
function shadowDomOverlay() {
    ...
    popup.append(
        closeButton, multiRange, startText, startSetContainer,
        endText, endSetContainer, buttonsContainer
    );
...
try {
    ...
    // Debug mode using browser directly instead of extension
    shadowDomOverlay();
}
